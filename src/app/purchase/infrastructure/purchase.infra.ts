...
export class PurchaseInfra extends BaseInfra {
  ...
  createPurchase(purchase: CreatePurchaseInvoiceDTO): Observable<void> {
    return this.createEntity<CreatePurchaseInvoiceDTO, void, void>(this.endpoint, purchase, () => {});
  }

  fetchPurchaseInvoices(
    pageIndex: number = 1,
    filter?: FilterIndex<PurchaseInvoiceDto>[],
    sort?: string
  ): Observable<IndexResponse<PurchaseInvoice>> {
